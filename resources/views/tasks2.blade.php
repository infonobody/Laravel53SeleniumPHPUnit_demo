...
@section('content')
    <div class="container" id="task">
        <div class="col-sm-offset-2 col-sm-8">
                    ...
                    <!-- Task Name -->
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                <button id="add" class="btn btn-default" @click="addTask()"><i class="fa fa-btn fa-plus"></i>Add Task
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Current Tasks -->
                <div id="panel" class="panel panel-default" v-show="tasks.length">
                            <div class="panel-heading">
                                Current Tasks
                            </div>
                                ...
                                <table id="table" class="table table-striped task-table">
                                    ...
                                    <tbody>
                                        <tr class="task" v-for="(task, index) in tasks">
                                            ...
                                            <!-- Task Delete Button -->
                                            <td>
                                                <button class="btn btn-danger delete" @click="removeTask(index)"><i
